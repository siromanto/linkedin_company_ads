...
if __name__ == '__main__':
    run(table_name='LINKEDIN_COMPANY_SHARE_STATISTIC_DATA', table_columns=helpers.RAW_DB_COLUMNS1)
    run(table_name='LINKEDIN_COMPANY_PAGE_STATISTIC_DATA', table_columns=helpers.RAW_DB_COLUMNS2)
